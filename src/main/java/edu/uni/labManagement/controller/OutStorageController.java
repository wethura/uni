...
@Api(description = "设备管理与实验室管理模块 - 设备出库")
@Controller
...
public class OutStorageController {
     ...
     * @return Result
     */
    @ApiOperation(value="新增设备出库记录", notes = "")
     ...
     * @return Result
     */
    @ApiOperation(value = "删除设备出库记录", notes = "")
     ...
     * @throws IOException
     */
    @ApiOperation(value = "查询单条设备出库记录", notes = "")
    @ApiImplicitParam(name = "id", value = "主键", required = true, dataType = "Long", paramType = "path")
    @GetMapping("outStorage/{id}")
    public void receive(@PathVariable Long id,
        ...
        if(json == null){
            Map<String,Object> res = outStorageService.select(id);
     ...
     * @throws IOException
     */
    @ApiOperation(value = "分页查询所有设备出库记录", notes = "")
    @ApiImplicitParam(name = "pageNum", value = "页码", required = true, dataType = "Integer", paramType = "path")
    @GetMapping(value = "/outStorages/list/{pageNum}")
    public void list(
        ...
        String json = cache.get(cacheName);
        if(json == null){
            PageInfo<Map<String,Object>> pageInfo = outStorageService.selectPage(pageNum);
     ...
     * @return Result
     */
    @ApiOperation(value = "删除所有设备出库记录缓存", notes = "")
