...
public class DeviceMoveInServiceImpl implements DeviceMoveInService {
    ...
    public boolean insert(Map<String,Object> json) {
        ...
        deviceMoveIn.setUniversityId(((User)authService.getUser()).getUniversityId());
        deviceMoveIn.setDatetime(new Date());
        deviceMoveIn.setByWho(((User)authService.getUser()).getId());
    ...
    public boolean update(Map<String,Object> json){
        ...
        DeviceMoveIn newDevice = deviceMoveInMapper.selectByPrimaryKey(Long.parseLong((String)json.get("Id")));
        newDevice.setId(null);
        newDevice.setDeleted(true);
        deviceMoveInMapper.insert(newDevice);
